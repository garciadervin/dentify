...
The following classes should be used for implementation:

- **Backgrounds:** `bg-clinical-blue`, `bg-sky-light`, `bg-surface`
- **Text:** `text-deep-slate`, `text-clinical-blue`, `text-neutral`
- **Shapes:** `rounded-3xl`, `rounded-2xl`
